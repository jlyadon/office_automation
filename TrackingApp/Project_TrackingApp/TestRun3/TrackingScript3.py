...
for num in set(tracking_df['Tracking Nos.']): # Using 'set' stops it from looping through the multiple packages associated with one tracking number multiple times.
